...
def sendEmail(request):
    ...
    for checked_res_id in checked_res_list:
        ...
        mail_html += "<h4> * 관련 링크 </h4><p>" + restaurant.restaurant_content + "</p><br>"
        mail_html += "<h4> * 관련 링크 </h4><p>" + restaurant.restaurant_keyword + "</p><br>"
        mail_html += "<br>"
    ...
    server. login("kmirae131@gmail.com", "kmirae9601")

    msg = MIMEMultipart('alternative')
    msg['Subject'] = inputTitle
    msg['From'] = "kmirae131@gmail.com"
